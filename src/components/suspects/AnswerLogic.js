...
class AnswerLogic {
  getQuestionResponse = (game, suspectId, question) => {
    // Determine which question function to use and data to pass
    // based on the question passed in
    const subjectId = question.subject === "murderer" ? game.gameData.murderer : suspectId;
    const response = question.responseText;

    switch (question.answerFunction) {
        case "checkEastSide": return checkEastSide(game, subjectId, response);
        case "checkMurdererGender": return checkMurdererGender(game, subjectId, response);
        case "checkTownLocation": return checkTownLocation(game, subjectId, response);
        case "checkMurderWeapon": return checkMurderWeapon(game, subjectId, response);
        case "check38Location": return check38Location(game, subjectId, response);
        case "check45Location": return check45Location(game, subjectId, response);
        case "checkEmptySeat": return checkEmptySeat(game, subjectId, response);
        case "checkPlaceNames": return checkPlaceNames(game, subjectId, response);
        case "checkWeaponLocation": return checkWeaponLocation(game, subjectId, response);
        case "checkPrints": return checkPrints(game, subjectId, response, question.subject);
  ...
  static checkEastSide = (game, subjectId, response) => {
    // Get the hash map
  ...
  static checkTownLocation = (game, subjectId, response) => {
    // Get the hash map
    const hashMap = makeLocationHashMap(game.gameData);
  ...
  static check38Location = (game, subjectId, response) => {
    ...
    const display = response.affirmative + game.gameData.locations[weaponLoc].name;
    return { answer: display };
  };

  static check45Location = (game, subjectId, response) => {
  ...
  static checkEmptySeat = (game, subjectId, response) => {
  ...
  static checkPlaceNames = (game, subjectId, response) => {
      // Get the hash map
      const hashMap = makeLocationHashMap(game.gameData);
  ...
  static checkWeaponLocation = (game, subjectId, response) => {
    // Get the hash map
    const hashMap = makeLocationHashMap(game.gameData);
  ...
  static checkPrints = (game, subjectId, response, targetWeapon) => {
    // Get the hash map
    const hashMap = makeLocationHashMap(game.gameData);
    ...
    const murdererGender = game.setupData.characters[game.gameData.murderer].gender;
